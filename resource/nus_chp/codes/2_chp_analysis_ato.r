...
#The difference of mean LDL between males and females is significant
t.test(chp$ldl~chp$smoker) 
View(chp)
#The difference of mean LDL between smoker and non-smoker is significant
...
# among non-smokers, no association between LDL & gender 
t.test(chp$ldl[chp$smoker %in% 1]~chp$female[chp$smoker %in% 1]) 
# among smokers, there is no association between LDL & gender 
# LDL- gender association is not confounded with smoking status 
